...
reg add HKLM\SYSTEM\CurrentControlSet\Services\dosvc /f /t REG_DWORD /v Start /d 4
...
reg add HKLM\SYSTEM\CurrentControlSet\Services\WpnService /f /t REG_DWORD /v Start /d 4
...
rem default - auto. permissions allow change config only to TrustedInstaller
reg add HKLM\SYSTEM\CurrentControlSet\Services\SgrmBroker /f /t REG_DWORD /v Start /d 4
rem default - auto
